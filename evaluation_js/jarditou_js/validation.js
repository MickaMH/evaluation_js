...
/*---------------------------------------------------------------------------------------------------------------------------------------------*/            
                /*NOM (nom)*/                                        
            {
                if (nom.validity.valueMissing)                              /*Si "valeur" du champ "nom" est vide*/
                {
                    ...
                    requisNom.style.fontSize = "1rem";                      /*Taille de police du message d'erreur*/
                ...
                else                                                        /*Sinon "NOM" valide*/
                {
                    ...
                    requisNom.style.fontSize = "1rem";                      /*Taille de police de la Coche*/
...
/*----------------------------------------------------------------------------------------------------------------------------------------------*/
                ...
                if (prenom.validity.valueMissing)               /*Fonctionne comme "NOM" mais ne permet que 20 caractères ( let prenomVerif )*/
                {
                    ...
                    requisPrenom.style.fontSize = "1rem";
...
/*----------------------------------------------------------------------------------------------------------------------------------------------*/
                ...
                {                                                                       
                    event.preventDefault();                                             /*Bloque l'envoi du Formulaire*/
                    requisSexe.textContent = "\u26a0 Champ obligatoire";                /*Affiche message d'erreur*/
                    requisSexe.style.fontSize = "1rem";                                 /*Taille de police du message d'erreur*/
                ...
                else                                                                    /*Sinon "SEXE" valide*/                
                {
                    ...
                    requisSexe.style.fontSize = "1rem";                                 /*Taille de police de la coche*/
...
/*----------------------------------------------------------------------------------------------------------------------------------------------*/
                ...
                if (mail.validity.valueMissing)                 /*Fonctionne comme "NOM" avec Regex ( let mailVerif )*/
                {
                    ...
                    requisMail.style.fontSize = "1rem";
...
/*----------------------------------------------------------------------------------------------------------------------------------------------*/
                ...
                {                                                               
                    event.preventDefault();                                     /*Bloque l'envoi du formulaire*/
                    requisMenuDer.textContent = "\u26a0 Champ obligatoire";     /*Affiche un message d'erreur*/
                    requisMenuDer.style.fontSize = "1rem";                      /*Taille de police du message d'erreur*/
                ...
                else                                                            /*SInon "MENU DEROULANT" valide*/                            
                {
                    ...
                    requisMenuDer.style.fontSize = "1rem";                      /*Taille de police de la coche*/
...
/*----------------------------------------------------------------------------------------------------------------------------------------------*/
                ...
                {
                    event.preventDefault();                                 /*Bloque l'envoi du formulaire*/
                    requisCoche.textContent = "\u26a0 Champ obligatoire";   /*Affiche un message d'erreur*/
                    requisCoche.style.fontSize = "1rem";                    /*Taille de police du message d'erreur*/
                ...
                else                                                        /*Sinon la case est coché : Valide */                                
                {
                    ...
                    requisCoche.style.fontSize = "1rem";                    /*Taille de police de la coche*/
